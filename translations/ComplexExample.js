...
//
// Complex Translation template - Translate to/from OSM+
//
...
// If you have FACC/DIGEST FCODES, this file has a good list of translations
...
{
    return complexExample.getDbSchema();
}
...
{
    return complexExample.toOsm(attrs, layerName, geometryType);
...
{
    return complexExample.toOgr(tags, elementType, geometryType)
